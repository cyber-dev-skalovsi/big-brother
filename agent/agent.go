// Package agent implements the BIGBROTHER monitoring agent that collects and serves system metrics.
//
// The agent runs on monitored systems and communicates collected data
// to the BIGBROTHER hub for centralized monitoring and alerting.
package agent
