...
func TestNewSensorConfig(t *testing.T) {
	...
	t.Setenv("BIGBROTHER_AGENT_PRIMARY_SENSOR", "test_primary")
	t.Setenv("BIGBROTHER_AGENT_SYS_SENSORS", "/test/path")
	t.Setenv("BIGBROTHER_AGENT_SENSORS", "test_sensor1,test_*,test_sensor3")
	t.Setenv("BIGBROTHER_AGENT_SENSORS_TIMEOUT", "7s")
