...
const (
	...
	noGPUFoundMsg   string = "no GPU found - see https://bigbrother.dev/guide/gpu"
	...
	go func() {
		...
		for {
			if err := gm.collectIntelStats(); err != nil {
				...
				slog.Warn("Error collecting Intel GPU data; see https://bigbrother.dev/guide/gpu", "err", err)
				time.Sleep(retryWaitTime)
				continue
			}
		}
