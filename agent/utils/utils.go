...
// GetEnv retrieves an environment variable with a "BIGBROTHER_AGENT_" prefix, or falls back to the unprefixed key.
func GetEnv(key string) (value string, exists bool) {
	if value, exists = os.LookupEnv("BIGBROTHER_AGENT_" + key); exists {
		return value, exists
	}
