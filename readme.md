...
> **Inspired by [beszel](https://github.com/henrygd/beszel)** (MIT). Big Brother is a fork/rebrand of Beszel with our own modifications built on top. Beszel is a lightweight server monitoring platform that includes Docker statistics, historical data, and alert functions.
