...
// across multiple systems (POST /api/bigbrother/user-alerts)
...
// (DELETE /api/bigbrother/user-alerts)
...
func (am *AlertManager) SendTestNotification(e *core.RequestEvent) error {
	...
	err = am.SendShoutrrrAlert(data.URL, "Test Alert", "This is a notification from Big Brother.", am.hub.Settings().Meta.AppURL, "View Big Brother")
	if err != nil {
