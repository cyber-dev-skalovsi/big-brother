...
func TestSystemAlertsCachePopulateAndFilter(t *testing.T) {
	...
	statusAlert, err := BIGBROTHERTests.CreateRecord(hub, "alerts", map[string]any{
		"name":   "Status",
		"system": system1.Id,
		"user":   user.Id,
		"min":    1,
	...
	cpuAlert, err := BIGBROTHERTests.CreateRecord(hub, "alerts", map[string]any{
		"name":   "CPU",
		"system": system1.Id,
		"user":   user.Id,
		"value":  80,
	...
	memoryAlert, err := BIGBROTHERTests.CreateRecord(hub, "alerts", map[string]any{
		"name":   "Memory",
		"system": system2.Id,
		"user":   user.Id,
		"value":  90,
