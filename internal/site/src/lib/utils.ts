 ...
 * @example
 * // Assuming system.host is "/var/run/BIGBROTHER.sock"
 * const hostname = getHostDisplayValue(system) // hostname will be "BIGBROTHER.sock"
 */
...
/** Get the hub URL from the global BIGBROTHER object */
export const getHubURL = () => globalThis.BIGBROTHER?.HUB_URL || window.location.origin
