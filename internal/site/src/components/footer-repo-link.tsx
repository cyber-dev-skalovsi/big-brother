...
export function FooterRepoLink() {
	...
	return (
		<div className="flex gap-1.5 justify-end items-center pe-3 sm:pe-6 mt-3.5 mb-4 text-xs opacity-80">
			<a
				href="https://github.com/cyber-dev-skalovsi/big-brother"
				target="_blank"
			...
			<a
				href="https://github.com/cyber-dev-skalovsi/big-brother/releases"
				target="_blank"
				className="text-muted-foreground hover:text-foreground duration-75"
				rel="noopener"
			>
				BIGBROTHER {globalThis.BIGBROTHER.HUB_VERSION}
			</a>
			{newVersion?.v && (
				<>
					<Separator orientation="vertical" className="h-2.5 bg-muted-foreground opacity-70" />
