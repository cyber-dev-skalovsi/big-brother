				...
				<CommandList>
					...
					<CommandGroup heading={t`Pages / Settings`}>
						...
						<CommandItem
							...
							onSelect={() => {
								window.location.href = "https://github.com/cyber-dev-skalovsi/big-brother/guide/what-is-BIGBROTHER"
							}}
						>
							...
							<CommandShortcut>github.com/cyber-dev-skalovsi/big-brother</CommandShortcut>
						</CommandItem>
					</CommandGroup>
					{isAdmin() && (
						<>
