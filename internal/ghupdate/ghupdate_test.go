...
func TestArchiveSuffix(t *testing.T) {
	tests := []struct {
		...
		{"armv5 agent", "bigbrother-agent", "linux", "arm", "5", "bigbrother-agent_linux_armv5.tar.gz"},
		{"armv6 keeps legacy name", "bigbrother-agent", "linux", "arm", "6", "bigbrother-agent_linux_arm.tar.gz"},
		{"hub keeps legacy arm name", "bigbrother", "linux", "arm", "6", "bigbrother_linux_arm.tar.gz"},
		{"armv7 agent", "bigbrother-agent", "linux", "arm", "7", "bigbrother-agent_linux_armv7.tar.gz"},
		{"newer arm keeps legacy name", "bigbrother-agent", "linux", "arm", "8", "bigbrother-agent_linux_arm.tar.gz"},
		{"unknown arm keeps legacy name", "bigbrother-agent", "linux", "arm", "", "bigbrother-agent_linux_arm.tar.gz"},
		{"amd64 hub", "bigbrother", "linux", "amd64", "", "bigbrother_linux_amd64.tar.gz"},
		{"windows", "bigbrother-agent", "windows", "amd64", "", "bigbrother-agent_windows_amd64.zip"},
	}
