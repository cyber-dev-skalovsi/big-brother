...
import (
	...
	"github.com/cyber-dev-skalovsi/big-brother/internal/tests"
...
func TestHasUser(t *testing.T) {
	...
	t.Run("BIGBROTHER_HUB_SHARE_ALL_SYSTEMS=true grants access to non-member", func(t *testing.T) {
		t.Setenv("BIGBROTHER_HUB_SHARE_ALL_SYSTEMS", "true")
		assert.True(t, sys.HasUser(hub, user2))
	})
