...
import (
	...
	"github.com/cyber-dev-skalovsi/big-brother/internal/hub/config"
	"github.com/cyber-dev-skalovsi/big-brother/internal/hub/systems"
	"github.com/cyber-dev-skalovsi/big-brother/internal/hub/utils"
...
func (h *Hub) registerApiRoutes(se *core.ServeEvent) error {
	...
	apiAuth := se.Router.Group("/api/bigbrother")
	apiAuth.Bind(apis.RequireAuth())
	// auth optional routes
	apiNoAuth := se.Router.Group("/api/bigbrother")
...
func (info *UpdateInfo) getUpdate(e *core.RequestEvent) error {
	...
	currentVersion, err := semver.Parse(strings.TrimPrefix(bigbrother.Version, "v"))
	if err != nil {
		return err
	}
...
// getContainerLogs handles GET /api/bigbrother/containers/logs requests
...
// getSystemdInfo handles GET /api/bigbrother/systemd/info requests
...
// refreshSmartData handles POST /api/bigbrother/smart/refresh requests
